...
#endif  // VL_DEBUG
VL_ATTR_COLD bool Vshifter___024root___eval_phase__stl(Vshifter___024root* vlSelf);
...
#endif
            VL_FATAL_MT("circuits/shifter.v", 3, "", "Settle region did not converge.");
        }
        __VstlIterCount = ((IData)(1U) + __VstlIterCount);
        __VstlContinue = 0U;
        if (Vshifter___024root___eval_phase__stl(vlSelf)) {
            __VstlContinue = 1U;
        }
...
VL_ATTR_COLD bool Vshifter___024root___eval_phase__stl(Vshifter___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vshifter__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vshifter___024root___eval_phase__stl\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Init
...
VL_ATTR_COLD void Vshifter___024root___dump_triggers__ico(Vshifter___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vshifter__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vshifter___024root___dump_triggers__ico\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vshifter___024root___ctor_var_reset(Vshifter___024root* vlSelf) {
    ...
    vlSelf->shift = VL_RAND_RESET_I(2);
    vlSelf->left_shift = VL_RAND_RESET_I(4);
    vlSelf->right_shift = VL_RAND_RESET_I(4);
}

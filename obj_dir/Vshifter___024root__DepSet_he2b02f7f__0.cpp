...
void Vshifter___024root___ico_sequent__TOP__0(Vshifter___024root* vlSelf);

void Vshifter___024root___eval_ico(Vshifter___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vshifter__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vshifter___024root___eval_ico\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
    if ((1ULL & vlSelfRef.__VicoTriggered.word(0U))) {
        Vshifter___024root___ico_sequent__TOP__0(vlSelf);
    }
}

VL_INLINE_OPT void Vshifter___024root___ico_sequent__TOP__0(Vshifter___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vshifter__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vshifter___024root___ico_sequent__TOP__0\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.left_shift = (0xfU & ((IData)(vlSelfRef.a) 
                                    << (IData)(vlSelfRef.shift)));
    vlSelfRef.right_shift = (0xfU & ((IData)(vlSelfRef.a) 
                                     >> (IData)(vlSelfRef.shift)));
}

void Vshifter___024root___eval_triggers__ico(Vshifter___024root* vlSelf);

bool Vshifter___024root___eval_phase__ico(Vshifter___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vshifter__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vshifter___024root___eval_phase__ico\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Init
    CData/*0:0*/ __VicoExecute;
    // Body
    Vshifter___024root___eval_triggers__ico(vlSelf);
    __VicoExecute = vlSelfRef.__VicoTriggered.any();
    if (__VicoExecute) {
        Vshifter___024root___eval_ico(vlSelf);
    }
...
bool Vshifter___024root___eval_phase__act(Vshifter___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vshifter__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vshifter___024root___eval_phase__act\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Init
...
bool Vshifter___024root___eval_phase__nba(Vshifter___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vshifter__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vshifter___024root___eval_phase__nba\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Init
...
#endif
            VL_FATAL_MT("circuits/shifter.v", 3, "", "Input combinational region did not converge.");
        }
        __VicoIterCount = ((IData)(1U) + __VicoIterCount);
        __VicoContinue = 0U;
        if (Vshifter___024root___eval_phase__ico(vlSelf)) {
            __VicoContinue = 1U;
        }
...
#endif
            VL_FATAL_MT("circuits/shifter.v", 3, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("circuits/shifter.v", 3, "", "Active region did not converge.");
            }
            vlSelfRef.__VactIterCount = ((IData)(1U) 
                                         + vlSelfRef.__VactIterCount);
            vlSelfRef.__VactContinue = 0U;
            if (Vshifter___024root___eval_phase__act(vlSelf)) {
                vlSelfRef.__VactContinue = 1U;
            }
        }
        if (Vshifter___024root___eval_phase__nba(vlSelf)) {
            __VnbaContinue = 1U;
        }
    }
}
...
void Vshifter___024root___eval_debug_assertions(Vshifter___024root* vlSelf) {
    ...
    if (VL_UNLIKELY((vlSelfRef.shift & 0xfcU))) {

...
void Vnot_gate___024root__trace_chg_0_sub_0(Vnot_gate___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vnot_gate___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vnot_gate___024root__trace_chg_0\n"); );
    // Init
    ...
    // Body
    Vnot_gate___024root__trace_chg_0_sub_0((&vlSymsp->TOP), bufp);
}

void Vnot_gate___024root__trace_chg_0_sub_0(Vnot_gate___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    (void)vlSelf;  // Prevent unused variable warning
    Vnot_gate__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vnot_gate___024root__trace_chg_0_sub_0\n"); );
...
void Vnot_gate___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vnot_gate___024root__trace_cleanup\n"); );
    // Init
    Vnot_gate___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vnot_gate___024root*>(voidSelf);
    Vnot_gate__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;

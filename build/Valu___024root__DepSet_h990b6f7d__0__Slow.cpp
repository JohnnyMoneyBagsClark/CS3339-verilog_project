...
#endif
            VL_FATAL_MT("circuits/alu.v", 1, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Valu___024root___ctor_var_reset(Valu___024root* vlSelf) {
    ...
    vlSelf->op_code = VL_RAND_RESET_I(4);
    vlSelf->carry_in = VL_RAND_RESET_I(1);
    vlSelf->result = VL_RAND_RESET_I(4);
    vlSelf->carry_out = VL_RAND_RESET_I(1);
    vlSelf->alu__DOT__and_out = VL_RAND_RESET_I(4);
    vlSelf->alu__DOT__or_out = VL_RAND_RESET_I(4);
    vlSelf->alu__DOT__xor_out = VL_RAND_RESET_I(4);
